      ...
      <!-- Unnamed (Repeater) -->
        ...
        <sql:setDataSource var="snapshot" driver="com.mysql.cj.jdbc.Driver"
            ...
            <sql:query dataSource="${snapshot}" var="result2">
              SELECT * from goods left join (SELECT * from carts where user_id = "group5")a on goods.id=a.good_id;
            </sql:query>
              <!-- Card (Group) -->
              <div id="u73" class="ax_default">
                
                <c:forEach var="row" items="${result2.rows}">
                <div id="u74-1" class="ax_default u74" data-label="Card" style="visibility: inherit; top: ${row.id*260-260}px;
                ...
                <div id="u75-1" class="ax_default shape u75" data-label="Card Background" style="width: 1112px; height: 240px; left: 0px; top: 0px;visibility: inherit">
                 ...
                 <!-- Paragraph (Rectangle) -->
                        <div id="u76-${row.id}" class="ax_default paragraph u76" data-label="Paragraph" style="width: 490px; height: 123px; left: 269px; top: 75px;visibility: inherit">
                          <div id="u76-${row.id}_div" class="u76_div" style="width: 490px; height: 123px;visibility: inherit"></div>
                        ...
                        <!-- Heading (Rectangle) -->
                        <div id="u77-${row.id}" class="ax_default heading_2 u77" data-label="Heading" style="width: 350px; height: 37px; left: 269px; top: 27px;visibility: inherit">
                          <div id="u77-${row.id}_div" class="u77_div" style="width: 350px; height: 37px;visibility: inherit"></div>
                        ...
                        <!-- Heading (Rectangle) -->
                        <div id="u78-${row.id}" class="ax_default heading_2 u78" data-label="Heading" style="width: 61px; height: 23px; left: 845px; top: 65px;visibility: inherit">
                          <div id="u78-${row.id}_div" class="u78_div" style="width: 61px; height: 23px;visibility: inherit"></div>
                ...
                <!-- Heading (Rectangle) -->
                <div id="u81-${row.id}" class="ax_default heading_2 u81" data-label="Heading" style="width: 72px; height: 23px; left: 1032px; top: 65px;visibility: inherit">
                  <div id="u81-${row.id}_div" class="u81_div" style="width: 72px; height: 23px;visibility: inherit"></div>
                  <div id="u81-${row.id}_text" class="text u81_text" style="visibility: inherit">
                    <p><span><c:out value="${row.count}"/></span></p>
                  </div>
                </div>
                ...
                <div id="u83-${row.id}" class="ax_default image u83" data-label="Image" style="width: 200px; height: 200px; left: 21px; top: 20px;visibility: inherit">
                ...
                <!-- Unnamed (Rectangle) -->
                <div id="u85-${row.id}" class="ax_default primary_button u85" style="width: 101px; height: 40px; left: 822px; top: 168px;visibility: inherit" onclick="addToCart(${row.id})">
                  <div id="u85-${row.id}_div" class="u85_div" style="width: 101px; height: 40px;visibility: inherit"></div>
                ...
                <!-- Unnamed (Rectangle) -->
                <div id="u86-${row.id}" class="ax_default primary_button u86" style="width: 101px; height: 40px; left: 970px; top: 168px;visibility: inherit" onclick="decreaseCart(${row.id})">
                  <div id="u86-${row.id}_div" class="u86_div" style="width: 101px; height: 40px;visibility: inherit"></div>
                ...
                <!-- Unnamed (Text Field) -->
                <div id="u87-${row.id}" class="ax_default text_field u87" style="width: 127px; height: 25px; left: 944px; top: 113px;visibility: inherit">
                  <div id="u87-${row.id}_div" class="u87_div" style="width: 127px; height: 25px;visibility: inherit"></div>
